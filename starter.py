...
def main():
    ...
    parser.add_argument('-trainname', type=str,default='mix.train.txt')
    parser.add_argument('-validname', type=str,default='mix.valid.txt')
    parser.add_argument('-testname', type=str,default='mix.test.txt')
